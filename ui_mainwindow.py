...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_2.addWidget(self.recLabel, 0, 0, 1, 1)
        self.morseReceiver = QtWidgets.QTextEdit(self.centralwidget)
        self.morseReceiver.setReadOnly(True)
        self.morseReceiver.setObjectName("morseReceiver")
        self.gridLayout_2.addWidget(self.morseReceiver, 3, 0, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.recLabel.setText(_translate("MainWindow", "Received"))
